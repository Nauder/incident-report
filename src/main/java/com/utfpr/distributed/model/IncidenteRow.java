...
public final class IncidenteRow {
    ...
    public IncidenteRow(int id_incidente, String data, String hora, String estado, String cidade, String bairro, String rua, String tipo_incidente) {
